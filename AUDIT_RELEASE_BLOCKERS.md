...
| **C-8**: `THIRD_PARTY_NOTICES.md` covering all bundled and runtime deps | S0 for release (legal) | **fixed** in commit `fd0ac46`. Evidence: enumerates every runtime dep + bundled FFmpeg; flags **Mutagen (GPL v2+)** and **PySide6-Fluent-Widgets (GPL v3 / Commercial)** as REVIEW REQUIRED; records PySideSix-Frameless-Window as an LGPL v3 transitive dependency of Fluent Widgets rather than a separate GPL blocker; pre-release checklist for the maintainer to walk through with counsel. |
